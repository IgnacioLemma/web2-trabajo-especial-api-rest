...
- **Descripción**: Devuelve un listado de las habitaciones ordenado de manera ascendente según el precio.
...
```json
{
    ...
    "rooms": [
        ...
        {
            "id_habitacion": 11,
            "Nombre": "Habitación Individual - Refugio en Rosario",
            "Tipo": "Individual",
            "Capacidad": 1,
            "Precio": 700,
            "foto_habitacion": "public/img/FotoHabitaciones/671558db707300.49851529.jpg"
        }
    ]
}
```
